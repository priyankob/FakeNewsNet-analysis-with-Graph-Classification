...
def construct_tweet_node_from_json(json_data):
    ...
    v = new_graph.in_degree(new_graph)
    root_node = [node for node, in_degree in v if in_degree == 0][0]
...
if __name__ == '__main__':
    fake_samples, real_samples = load_dataset("data/nx_network_data", "gossipcop")
